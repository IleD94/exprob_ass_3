#include <ros/ros.h>
#include <exp_assignment3/ErlOracle.h>
#include <exp_assignment3/Oracle.h>
...
int markerID[30]; 
exp_assignment3::ErlOracle oracle_msgs[30];
 


bool oracleService(exp_assignment3::Oracle::Request &req, exp_assignment3::Oracle::Response &res)
	{
		res.ID = winID;
		return true;
	}
